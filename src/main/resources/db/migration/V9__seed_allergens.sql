...
SELECT id, 'es', name_es, desc_es FROM (VALUES
    ...
    ('SOYBEANS', 'Soja', 'Soja y productos a base de soja'),
    ('MILK', 'Leche', 'Leche y sus derivados (incluida la lactosa)'),
    ('NUTS', 'Frutos de cáscara', 'Frutos de cáscara y productos derivados'),
...
SELECT id, 'en', name_en, desc_en FROM (VALUES
    ...
    ('SOYBEANS', 'Soybeans', 'Soybeans and products thereof'),
    ('MILK', 'Milk', 'Milk and products thereof (including lactose)'),
    ('NUTS', 'Nuts', 'Nuts and products thereof'),
